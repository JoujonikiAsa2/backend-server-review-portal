...
router.get("/my-payments/:email", (0, AuthGurd_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.USER), Payment_controllers_1.PayementControllers.getAllPayments);
